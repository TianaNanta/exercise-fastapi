...
class AdminModel(Base):
    ...
    avatar: Mapped[bytes] = mapped_column(LargeBinary)  # noqa: WPS432
    date_creation: Mapped[str] = mapped_column(DateTime(timezone=True), server_default=func.now())  # noqa: WPS432
